...
class PPOLSTMTests(unittest.TestCase):
    ...
    @patch.object(PPO_lstm_server, "Mage", FakeMage)
    def test_training_uses_mage_episode_and_dashboard_metrics(self):
        args = Args(
            total_timesteps=4,
            num_steps=4,
            num_minibatches=2,
