...
python -c "from Custom_enviornments.Test_Env import Mystic; print(Mystic.Mystic.__name__)"
...
```text
Custom_enviornments/Test_Env/Mystic.py
```
...
Evaluate recurrent PPO on the custom `Mystic` environment:
